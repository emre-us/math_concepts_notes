...
\usepackage{Sweave}
\begin{document}
\input{Math_Concepts_2_Functions-concordance}
...
\begin{tabular}{c c c}
      ...
      \begin{tikzpicture}
            ...
            \draw[<->] (0,-1) -- (0,4.5) node[above left] {$\mathbb{R}$};
            \draw[<->, scale=0.5, domain=-3:3, smooth, variable=\x,] plot ({\x}, {\x*\x}) node[left] {$f(x)$}; %scaled it by half to fit in page. plot command is in (x,y) format where y=x^2.
      ...
      \begin{tikzpicture}
            ...
            \draw[<->] (0,-1) -- (0,4.5) node[above left] {$\mathbb{R}$};
            \draw[<->, scale=0.5, domain=0:3, smooth, variable=\x,] plot ({\x}, {\x*\x}) node[left] {$g(x)$};
      ...
      \begin{tikzpicture}
            \draw[<->] (-2.5,0) -- (2.5,0) node[right] {$\mathbb{R}$};
            \draw[<->] (0,0) -- (0,4.5) node[above left] {$\mathbb{R^+}$};
            \draw[<->, scale=0.5, domain=-3:3, smooth, variable=\x,] plot ({\x}, {\x*\x}) node[left] {$h(x)$};
            \draw[ultra thin, <->] (-2,0.5) -- (2,0.5);
            \draw[fill] (-0.5,0.5) circle [radius=0.05];
            \draw[fill] (0.5,0.5) circle [radius=0.05];
      \end{tikzpicture}
      ...
      \begin{tikzpicture}
            \draw[->] (0,0) -- (2.5,0) node[right] {$\mathbb{R^+}$};
            \draw[<->] (0,0) -- (0,4.5) node[above left] {$\mathbb{R^+}$};
            \draw[<->, scale=0.5, domain=0:3, smooth, variable=\x,] plot ({\x}, {\x*\x}) node[left] {$k(x)$};
            \draw[ultra thin, ->] (0,0.5) -- (2,0.5);
            \draw[ultra thin, ->] (0,2) -- (2,2);
            \draw[fill] (0,0) circle [radius=0.05];
            \draw[fill] (0.5,0.5) circle [radius=0.05];
...
To prove that $g$ and $k$ are injective,
