...
\usepackage{Sweave}
\begin{document}
\input{Math_Concepts_1_Sets-concordance}
...
\noindent \boxed{theorem} \quad A \emph{theorem} is an important result (ie, sentence or mathematical expression that is true) that has been proved. % '\quad' is for spacing, '\hspace{12pt}' works similarly.

\medskip
\noindent \boxed{proposition} \quad A \emph{proposition} is a result that is less important than a theorem. It has also been proved.


\medskip
\noindent \boxed{lemma} \quad A \emph{lemma} is typically a result that is proved before a proposition or a theorem, and is used to prove the subsequent propositon or theorem.


\medskip
\noindent \boxed{corollary} \quad A \emph{corollary} is a result that is proved after a proposition or a theorem, and which follows quickly from a the theorem or proposition. it is often a special case of the proposition or theorem.


\medskip
\noindent \boxed{conjecture} \quad A \emph{conjecture} is a statement someone guesses to be true, although they are not yet able to prove or disprove it.
...
\medskip
\noindent \boxed{\mathbb{N}} \quad The set of \emph{natural numbers}, denoted $\mathbb{N}$, is the set \{1, 2, 3, \dots\}\footnote{Note that it does not include 0.} For e.g.,
    \begin{itemize}
...
\medskip
\noindent \boxed{\mathbb{Z}} \quad The set of \emph{integers}, denoted $\mathbb{Z}$ is the set \{\dots, -3, -2, -1, 0, 1, 2, 3, \dots \}. For e.g.,
    \begin{itemize}
...
\medskip
\noindent \boxed{\mathbb{Q}} \quad The set of \emph{rational numbers}, denoted $\mathbb{Q}$, is the set $\mathbb{Q} = \{\frac{a}{b}: a,b \in \mathbb{Z}, b \neq 0 \}$
...
\medskip
\noindent \boxed{U} \quad If $A \subseteq U$ then $U$ is called a \emph{universal set} of $A$.
...
\medskip
\noindent \boxed{A^\complement} \quad The \emph{complement} of $A$ in $U$ is $A^\complement = U \setminus A$.
...
\medskip
\noindent \boxed{\mathcal{P}(A)} The \emph{power set} of $A$ is $\mathcal{P}(A) = \{X : X \subseteq A \}$ where every element of $\mathcal{P}(A)$ is a set itself, just like a box can contain other boxes. What the definition is saying is that if $X$ is a subset of $A$, then $X$ is an element of $\mathcal{P}(A)$.
      \begin{itemize}
...
\medskip
\noindent \boxed{|A|} \quad The \emph{cardinality} of $A$ is the number of elements in $A$.
      \begin{itemize}
...
\medskip
\noindent \boxed{A \times B} \quad The \emph{Cartesian product} of $A$ and $B$ is $A \times B = \{(a,b): a \in A \text{ and } b \in B \} $. This can be thought of as a way to "multiply" sets. The product of A and B creates a new set with each element forming an ordered pair (a,b).
      \begin{itemize}
