...
\author{Emre Usenmez}
\thanks{Gonville \verb|&| Caius College. These notes made liberal use of Prof Jay Cummings' book 'Proofs'.}
\date{August 2023}
...
\hfill\\ % The \hfill fills the line with empty space, so that \\ can end this line without an error.
